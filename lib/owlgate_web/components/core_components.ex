defmodule OwlGateWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OwlGateWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OwlGateWeb.Gettext, "errors", msg, opts)
    end
  end
